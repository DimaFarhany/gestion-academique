...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="fw-bold mb-1">Ajouter un cours</h1>
        <p class="text-muted mb-0">Créer un nouveau cours et l’assigner à un enseignant.</p>
    </div>
    ...
    <div class="card-body p-4">
        <form action="{{ route('courses.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="credits" class="form-control" value="{{ old('credits', 0) }}" required>
